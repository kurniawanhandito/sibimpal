<div class="admin-content col-md-10">
	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			<form action="<?php echo base_url()."index.php/adminuniversitas/keloladatabarang/do_inputdatabarang";?>" method="POST">
				<div class="form-group">
					<label for="inputNamaBarang">Nama Barang</label>
					<input type="text" class="form-control" name="inputNamaBarang" placeholder="Nama Barang" required/>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="number" class="form-control" name="inputJumlah" placeholder="Jumlah" required min="0"/>
				</div>
